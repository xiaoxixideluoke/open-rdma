...
`timescale 1ps/1ps
module top_mkTestAcxBram72kSdpConflictRW (
    // pll lock
    input pll_1_lock,
    // jtap ports:
    ...
    wire [144 : 0] readResp;
    wire [31:0] zeroErrorCnt, oneErrorCnt, correctCnt;
    wire [13:0] ra;
    wire errorOccured;

    mkTestAcxBram72kSdpConflictRW dutInst(
        .CLK(clk),
        .RST_N(rstn),
        .lastError(lastError),
    ...
    /********** snapshot *********************************************************/
    localparam integer MONITOR_WIDTH = 32 * 3 + 145 + 145 + 14 + 1;
