...
`timescale 1ps/1ps
module top_mkTestFourChannelButterflyMergeTimingTest (
    // pll lock
    input pll_1_lock,
    // jtap ports:
    ...
    wire [149 : 0] getOutput;

    mkTestFourChannelButterflyMergeTimingTest dutInst(
        .CLK(clk),
        .RST_N(rstn),
        .getOutput(getOutput)
    ...
    /********** snapshot *********************************************************/
    localparam integer MONITOR_WIDTH = 150;
